...
func TestGetMavenArtifactsSuccess(t *testing.T) {
	...
	assert.Equal(t, mii.artifacts[0].BazelLabel, "@maven//:biz_aQute_bnd_biz_aQute_bnd_util")
	...
	assert.Equal(t, mii.artifacts[2].BazelLabel, "@maven//:com_benasher44_uuid_jvm")
